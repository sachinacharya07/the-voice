...
const SOCIAL = [
  ...
  {
    name: 'Instagram',
    url: 'https://www.instagram.com/thev.0ice?igsh=MzQ0dWJ5NG15anph',
    svg: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
  ...
  {
    name: 'Reddit',
    url: 'https://www.reddit.com/r/the_voicee/s/HUeA5yKsVt',
    svg: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
    ...
    <footer className={styles.footer}>
      <div className={styles.inner}>
        <div className={styles.top}>
            ...
            <div className={styles.socials}>
              {SOCIAL.map(s => (
                <a key={s.name} href={s.url} target="_blank" rel="noopener noreferrer"
                  className={styles.socialIcon} title={s.name} aria-label={s.name}>
                  {s.svg}
                </a>
              ))}
            </div>
          ...
          <div className={styles.links}>
            ...
            <div className={styles.col}>
              ...
              <Link to="/letters">Letters to Editor</Link>
        ...
        <div className={styles.bottom}>
          ...
          <span>Built by <strong>Sachin Acharya</strong> · <span className={styles.tisa}>TISA 2026</span></span>
          <a href="mailto:the.voice.of.students01@gmail.com">the.voice.of.students01@gmail.com</a>
        </div>
      </div>
    </footer>
  )
