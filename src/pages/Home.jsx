                  ...
                  {hero.coverImage && (
                    <div className={styles.heroImg}>
                      ...
                      <div className={styles.heroTextOverlay}>
                        <span className={styles.cat} style={{ color: CAT_COLORS[hero.category], borderColor: CAT_COLORS[hero.category] }}>
                        ...
                        <div className={styles.heroMeta}>
                          ...
                          <span>·</span>
                          <span>{ago(hero.publishedAt)}</span>
                          <span>·</span>
                ...
                <div className={styles.secondaryStack}>
                  {secondary.map(a => (
                    <Link key={a.id} to={`/article/${a.id}`} className={styles.stackCard}>
                      {a.coverImage && <div className={styles.stackImg}><img src={a.coverImage} alt="" /></div>}
