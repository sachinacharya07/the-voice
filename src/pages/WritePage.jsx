      ...
      <div className={styles.successWrap}>
        <div className={styles.successCard}>
          ...
          <div className={styles.successActions}>
            ...
            <button onClick={()=>{setSuccess(false);setForm({title:'',category:'school',summary:'',body:'',pullQuote:'',coAuthorName:'',coAuthorEmail:''});setTags([]);setSources(['']);setCoverImage(null);setCoverPreview(null);setInlineImages([])}} className={styles.btnOutline}>Write another</button>
          </div>
        </div>
      </div>
    </PageWrapper>
